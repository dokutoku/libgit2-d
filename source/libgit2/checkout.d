...
enum
{
	GIT_CHECKOUT_NONE = .git_checkout_strategy_t.GIT_CHECKOUT_NONE,
	GIT_CHECKOUT_SAFE = .git_checkout_strategy_t.GIT_CHECKOUT_SAFE,
	GIT_CHECKOUT_FORCE = .git_checkout_strategy_t.GIT_CHECKOUT_FORCE,
	GIT_CHECKOUT_RECREATE_MISSING = .git_checkout_strategy_t.GIT_CHECKOUT_RECREATE_MISSING,
	GIT_CHECKOUT_ALLOW_CONFLICTS = .git_checkout_strategy_t.GIT_CHECKOUT_ALLOW_CONFLICTS,
	GIT_CHECKOUT_REMOVE_UNTRACKED = .git_checkout_strategy_t.GIT_CHECKOUT_REMOVE_UNTRACKED,
	GIT_CHECKOUT_REMOVE_IGNORED = .git_checkout_strategy_t.GIT_CHECKOUT_REMOVE_IGNORED,
	GIT_CHECKOUT_UPDATE_ONLY = .git_checkout_strategy_t.GIT_CHECKOUT_UPDATE_ONLY,
	GIT_CHECKOUT_DONT_UPDATE_INDEX = .git_checkout_strategy_t.GIT_CHECKOUT_DONT_UPDATE_INDEX,
	GIT_CHECKOUT_NO_REFRESH = .git_checkout_strategy_t.GIT_CHECKOUT_NO_REFRESH,
	GIT_CHECKOUT_SKIP_UNMERGED = .git_checkout_strategy_t.GIT_CHECKOUT_SKIP_UNMERGED,
	GIT_CHECKOUT_USE_OURS = .git_checkout_strategy_t.GIT_CHECKOUT_USE_OURS,
	GIT_CHECKOUT_USE_THEIRS = .git_checkout_strategy_t.GIT_CHECKOUT_USE_THEIRS,
	GIT_CHECKOUT_DISABLE_PATHSPEC_MATCH = .git_checkout_strategy_t.GIT_CHECKOUT_DISABLE_PATHSPEC_MATCH,
	GIT_CHECKOUT_SKIP_LOCKED_DIRECTORIES = .git_checkout_strategy_t.GIT_CHECKOUT_SKIP_LOCKED_DIRECTORIES,
	GIT_CHECKOUT_DONT_OVERWRITE_IGNORED = .git_checkout_strategy_t.GIT_CHECKOUT_DONT_OVERWRITE_IGNORED,
	GIT_CHECKOUT_CONFLICT_STYLE_MERGE = .git_checkout_strategy_t.GIT_CHECKOUT_CONFLICT_STYLE_MERGE,
	...
	GIT_CHECKOUT_CONFLICT_STYLE_ZDIFF3 = .git_checkout_strategy_t.GIT_CHECKOUT_CONFLICT_STYLE_ZDIFF3,
...
enum
{
	GIT_CHECKOUT_NOTIFY_NONE = .git_checkout_notify_t.GIT_CHECKOUT_NOTIFY_NONE,
	GIT_CHECKOUT_NOTIFY_CONFLICT = .git_checkout_notify_t.GIT_CHECKOUT_NOTIFY_CONFLICT,
	GIT_CHECKOUT_NOTIFY_DIRTY = .git_checkout_notify_t.GIT_CHECKOUT_NOTIFY_DIRTY,
	GIT_CHECKOUT_NOTIFY_UPDATED = .git_checkout_notify_t.GIT_CHECKOUT_NOTIFY_UPDATED,
	GIT_CHECKOUT_NOTIFY_UNTRACKED = .git_checkout_notify_t.GIT_CHECKOUT_NOTIFY_UNTRACKED,
	GIT_CHECKOUT_NOTIFY_IGNORED = .git_checkout_notify_t.GIT_CHECKOUT_NOTIFY_IGNORED,

	GIT_CHECKOUT_NOTIFY_ALL = .git_checkout_notify_t.GIT_CHECKOUT_NOTIFY_ALL,
}
...
.git_checkout_options GIT_CHECKOUT_OPTIONS_INIT()
