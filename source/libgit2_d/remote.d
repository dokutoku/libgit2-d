 ...
 *
 * @param out_ pointer to the new remote objects
 ...
 *
 * @param out_ pointer to the array
 ...
 *
 * @param out_ a string array which receives the names of the remotes
 ...
 * @param version_ Version of struct; pass `GIT_REMOTE_CALLBACKS_VERSION`
 * @return Zero on success; -1 on failure.
 */
//GIT_EXTERN
 ...
 * @param update_fetchhead whether to write to FETCH_HEAD. Pass 1 to behave like
 * git.
 * @param download_tags what the behaviour for downloading tags is for this
 * fetch. This is ignored for push. This must be the same value passed to
 * `git_remote_download()`.
 * @return 0 or an error code
 */
//GIT_EXTERN
