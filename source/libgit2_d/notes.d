 ...
 *
 * @param out_ pointer to the iterator
 ...
 *					null in case of error.
 *					When removing a note a new tree containing all
 *notes sans the note to be removed is created and a new commit pointing to that
 *tree is also created. In the case where the resulting tree is an empty tree a
 *new commit pointing to this empty tree will be returned.
 * @param repo repository where the note lives
 * @param notes_commit a pointer to the notes commit object
 * @param author signature of the notes commit author
 * @param committer signature of the notes commit committer
 ...
 *
 * @param out_ buffer in which to store the name of the default notes reference
